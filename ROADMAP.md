...
- [ ] **Tap a word.** *Done in both modes: Live Text's selection, and in Vision mode since 2026-09-24 a tap that lands on a character by Vision's own character boxes, outlines the word over it and reads it out as a selection would.* Still to do: editing more than a character at a time on the page.
