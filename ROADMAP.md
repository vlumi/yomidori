...
- [ ] **The first field round (2026-09-21), what remains of it.** The still kept with a card only on request and removable later, the sentence editable; the meaning always asked, and a pitch question that picks the pattern from all the reading allows.
...
- [ ] **Stroke order on the kanji screen**, from KanjiVG (CC BY-SA 3.0), drawn as the strokes in order; wanted, after the field round.
